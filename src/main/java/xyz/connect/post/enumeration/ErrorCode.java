...
public enum ErrorCode {
    ...
    INVALID_API_PARAMETER(HttpStatus.BAD_REQUEST, "P004", ""), //ExceptionHandler 에서 메시지 작성
    EXCEED_MAX_UPLOAD_COUNT(HttpStatus.BAD_REQUEST, "P005", ""),
    NOT_FOUND(HttpStatus.NOT_FOUND, "P006", "리소스가 존재하지 않습니다."),
    TYPE_MISMATCH(HttpStatus.BAD_REQUEST, "P007", "잘못된 파라미터의 데이터 타입입니다.");
